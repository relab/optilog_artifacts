...
type Ranking interface {
	...
	//UpdateLatency updates the latency between the replicas.
	UpdateLatency(proposer hotstuff.ID, latencyVector []uint32)
	...
	GetLatencyMatrix() map[hotstuff.ID]map[hotstuff.ID]uint32
	// //Get
