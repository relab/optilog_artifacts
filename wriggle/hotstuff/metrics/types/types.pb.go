...
type SentBytes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Event       *Event `protobuf:"bytes,1,opt,name=Event,proto3" json:"Event,omitempty"`
	SendEventrd uint64 `protobuf:"varint,2,opt,name=sendEventrd,proto3" json:"sendEventrd,omitempty"`
}

func (x *SentBytes) Reset() {
	*x = SentBytes{}
	if protoimpl.UnsafeEnabled {
...
func (x *SentBytes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SentBytes) ProtoMessage() {}

func (x *SentBytes) ProtoReflect() protoreflect.Message {
	mi := &file_metrics_types_types_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SentBytes.ProtoReflect.Descriptor instead.
func (*SentBytes) Descriptor() ([]byte, []int) {
	return file_metrics_types_types_proto_rawDescGZIP(), []int{5}
}

func (x *SentBytes) GetEvent() *Event {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *SentBytes) GetSendEventrd() uint64 {
	if x != nil {
		return x.SendEventrd
	}
	return 0
}
...
var file_metrics_types_types_proto_rawDesc = []byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x73, 0x22, 0x51, 0x0a, 0x09, 0x53, 0x65, 0x6e, 0x74,
	0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x22, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x52, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x73, 0x65, 0x6e,
	0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b,
	0x73, 0x65, 0x6e, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x72, 0x64, 0x42, 0x29, 0x5a, 0x27, 0x67,
...
var file_metrics_types_types_proto_goTypes = []interface{}{
	...
	(*SentBytes)(nil),             // 5: types.SentBytes
...
var file_metrics_types_types_proto_depIdxs = []int32{
	...
	1, // 6: types.SentBytes.Event:type_name -> types.Event
...
func file_metrics_types_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_metrics_types_types_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SentBytes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
